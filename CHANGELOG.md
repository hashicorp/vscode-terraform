...
BREAKING CHANGES:
 ...
 - Setting [`terraform-ls.rootModules`](https://github.com/hashicorp/vscode-terraform/blob/v2.23.1/docs/settings-migration.md) has been deprecated and is ignored. Users should instead leverage the VS Code workspace functionaliy and add the folder to a workspace to be indexed ([#1003](https://github.com/hashicorp/terraform-ls/pull/1003))
...
[Unreleased]: https://github.com/hashicorp/vscode-terraform/compare/v2.23.0...main
